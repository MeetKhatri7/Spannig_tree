...
# If user wants to take input using GUI
take_input(G)
print(G)

# If user wants to take input using Terminal
...
x = 35
y = 70
for creation in range(len(G.nodes())):
    x_ending = x+40
    y_ending = y+40
    node = Node(canvas, creation, name_of_nodes[creation], x, y, x_ending, y_ending)
